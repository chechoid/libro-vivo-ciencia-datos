...
* `status(data)`: Análisis de la estructura del conjunto de datos
...
La función `status` toma un data frame y genera una _tabla de estado_ que nos puede ayudar a quitar rápidamente atributos (o variables) en base a todas las métricas descriptas en la sección anterior. Por ejemplo:
